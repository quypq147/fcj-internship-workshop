...
* Learned the basics of the machine learning workflow on AWS.

![Day 1 screenshot](/images/1-Worklog/1.12-Week12/day1.png)

#### Day 2 - AWS: SageMaker Immersion Day 1

* Followed the immersion day scenario and practiced the main ML setup steps.

![Day 2 screenshot](/images/1-Worklog/1.12-Week12/day2.png)

#### Day 3 - AWS: SageMaker Immersion Day 2

* Completed the remaining hands-on SageMaker exercises.

![Day 3 screenshot](/images/1-Worklog/1.12-Week12/day3.png)

#### Day 4 - AWS: Migration Review

* Revisited cloud migration lessons and the key planning points.

![Day 4 screenshot](/images/1-Worklog/1.12-Week12/day4.png)

#### Day 5 - AWS: Best Practices Review

* Reinforced architecture and operations best practices.

![Day 5 screenshot](/images/1-Worklog/1.12-Week12/day5.png)

#### Day 6 - AWS: Hands-on Review

* Reviewed the full set of hands-on tasks and the skills practiced during the journey.

![Day 6 screenshot](/images/1-Worklog/1.12-Week12/day6.png)

#### Day 7 - AWS: Journey Finalization

* Summarized the full journey and finalized the worklog report.

![Day 7 screenshot](/images/1-Worklog/1.12-Week12/day7.png)
