...
* Biết phối hợp backup, peering, transit gateway và clustering trong thiết kế mạng và ứng dụng.
* Nhận diện được các mô hình triển khai phù hợp cho workload Windows và SQL Server.
